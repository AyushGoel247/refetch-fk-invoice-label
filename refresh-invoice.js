...
async function refreshInvoice() {
    // arr.forEach(async (spCode) => {
    for (let spCode of arr) {
        console.log("Refetching label for  : ", spCode);
        try {
            const res = await fetch("https://capl.unicommerce.com/data/oms/invoice/update", {
                headers: {
